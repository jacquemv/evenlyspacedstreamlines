...
int main()
{
    ...
    read_orient_txt("../data/test_mesh2d.orient2", nt, orient);
    srand(1256736);
    randomize_orient(nt, orient, 1, 1);

    StreamlineEngine engine;
    engine.initialize(nv, nt, ver, tri, orient, 1, 0);
    double radius = 0.2;
    ...
    engine.setup(radius, 1024, 32, 1, 90, 0, 0.1, 129873, 0);
